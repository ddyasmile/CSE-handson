...
docker run  \
    ...
    --network handson3net \
    --ip 172.18.0.11 \
    -v /home/ddya/cse-tot/reading/handson3/secondstep/nginxstatic:/etc/nginx/conf.d \
...
docker run  \
    ...
    --network handson3net \
    --ip 172.18.0.12 \
    -v /home/ddya/cse-tot/reading/handson3/secondstep/nginxproxy:/etc/nginx/conf.d \
    -p 127.0.0.1:80:80 \
    -d nginx
